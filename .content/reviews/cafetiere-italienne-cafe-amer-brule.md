...
| `internal-linking-audit` | PASS éditorial | dosage, utilisation, mouture, café et fuite sont les suites logiques |
...
- visuel BFL sans qualification → caption explicite ajoutée.
