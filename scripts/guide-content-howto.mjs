...
<div class="container template-grid guide-layout">
  <article class="guide-article content-main">
    ...
    <section>
      <h2>4. Chauffez à feu doux à moyen</h2>
      <p>Bialetti recommande une chauffe douce à moyenne pour la Moka Express. Sur une cuisinière à gaz, la flamme doit rester sous la base et ne pas remonter le long de la cafetière. Alessi donne également une consigne de chauffe moyenne à basse pour ses moka.</p>
      <p>Le but n’est pas de faire bouillir la cafetière le plus vite possible. Une chauffe trop agressive n’est pas la méthode recommandée par ces fabricants et peut dégrader le résultat.</p>
      <div class="guide-callout"><strong>Repère utile :</strong> utilisez une puissance qui chauffe la base de façon régulière sans faire lécher les parois par la flamme. Le réglage exact dépend de votre plaque et de votre cafetière ; il n’existe pas de chiffre universel valable pour tous les équipements.</div>
    </section>
    ...
    <section>
      <h2>Les erreurs à éviter pendant l’utilisation</h2>
      <ul class="guide-list">
