...
<section class="section guide-hub-group"><div class="container"><div class="section-head"><div><span class="eyebrow">01 · Choisir</span><h2>Partir des contraintes qui éliminent les mauvais choix</h2></div><p>Plaque, volume, matériau et café : commencez par les critères qui changent réellement la décision.</p></div><div class="directory">
...
<section class="section guide-hub-group"><div class="container"><div class="section-head"><div><span class="eyebrow">02 · Préparer</span><h2>Maîtriser la méthode avant d’ajuster la recette</h2></div><p>La procédure de base d’abord ; dosage et mouture ensuite, une variable à la fois.</p></div><div class="directory">
...
<section class="section guide-hub-group"><div class="container"><div class="section-head"><div><span class="eyebrow">03 · Entretenir & diagnostiquer</span><h2>Faire la différence entre entretien courant, tartre et panne</h2></div><p>Nettoyage, détartrage, joint et fuite ne répondent pas au même problème. Chaque guide isole le bon diagnostic avant l’action.</p></div><div class="directory">
